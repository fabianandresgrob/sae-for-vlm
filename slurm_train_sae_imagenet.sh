#!/bin/bash
#SBATCH --job-name=train-sae-imagenet
...
ACTIVATIONS_DIR="${SAE_EXPERIMENT_DIR}/activations/imagenet_train"
VAL_ACTIVATIONS_DIR="${SAE_EXPERIMENT_DIR}/activations/imagenet_val"
